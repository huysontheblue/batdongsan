  ...
  <section class="container detail-properties">
    ...
    <div class="row mb-4">
      <div class="col-lg-6 mb-4">
        <img height="460" style="object-fit: cover" class="rounded w-100" src="{{ Storage::url($property->galleries()->latest()->first()->path) }}"/>
      </div>
      <div class="col-lg-6">
        <div class="row">
          @foreach($property->galleries->take(4) as $gallery)
            <div class="col-lg-6 mb-4">
              <img style="object-fit: cover" class="img-fluid h-100 w-100 rounded" src="{{ Storage::url($gallery->path) }}"/>
            </div>
          @endforeach
        </div>
      </div>
      ...
      <div class="col-lg-8 mb-4">
        <div class="card border-0 p-4">
          <div class="d-flex justify-content-between mb-4">
            <h1>{{ $property->price }}.000.000 VNĐ</h1>
          ...
          <h3 class="mb-2">Mô tả</h3>
            ...
            <h4 class="mb-2">Các tiện ích đi kèm</h4>
            <div class="d-grid grid-custom">
        ...
        <div class="col-lg-4">
          <div class="card py-5 h-100 border-0">
            <div class="mx-auto text-center">
              <img width="110" height="110" style="object-fit: cover" src="{{ storage::url($property->agent->profile) }}" class="mb-3 rounded-circle d-block mx-auto border border-warning"/>
              <span class="mb-1 d-block text-secondary">Người đăng</span>
              ...
              <ul class="list-unstyled mb-5">
                <li style="column-gap: 3rem" class="text-secondary mb-3 d-flex justify-content-between">
                  <span class="fw-light">Điện thoại : </span> {{ $property->agent->phone }}
                </li>
                <li style="column-gap: 3rem" class="text-secondary mb-3 d-flex justify-content-between">
          ...
          <a href="tel:{{ $property->agent->phone }}" class="w-75 p-3 text-center mx-auto btn btn-primary">Liên hệ</a>
        </div>
      </div>
    </div>
  </section>
